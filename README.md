...
## Directory Structure
- `DSP/lib/dsp/` — Signal processing and crypto logic
- `DSP/lib/audio/` — Audio pipeline and real speaker/mic I/O
- `UI/Flutter/lib/` — Buildable Flutter app and screens
- `Testing/` — Stage-organized DSP and pipeline tests
- `docs/` — Reference material, including `docs/copilot_prompts/` (prompts used to scaffold each stage)
- `UI/Flutter/assets/host_songs/` — Sample WAV host songs for testing
